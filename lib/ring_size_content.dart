                ...
                itemBuilder: (BuildContext context, int index) {
                  return Container(
                    decoration: BoxDecoration(
                      border: Border.all(
                          color: Colors.black.withAlpha(20), width: 0.3),
                    ),
                  );
                },
              ),
            ...
            Center(
              child: Container(
                ...
                decoration: BoxDecoration(
                    ...
                    border: Border.all(
                        color: Colors.blueGrey.withAlpha(180), width: 2.5)),
                child: Row(
                  children: [
                    if (widget.ringSize > 5)
                      Icon(
                    ...
                    Container(
                      ...
                      child: Text(
                        ...
                        style: textStyle.copyWith(fontSize: (diameter / 2.4)),
                      ),
                    ),
                    Flexible(
                        child: Container(
